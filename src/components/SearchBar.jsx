...
const SearchBar = () => {
  ...
  return (
    <div className="bg-[#F5F5F3] relative">
      ...
      {filter && (
        <ul className="absolute top-full left-0 z-20 p-5 bg-slate-400 grid grid-cols-1 md:grid-cols-3 gap-1">
          {filter.map((item, index) => (
            <li
              className="w-full p-8 rounded bg-slate-200 grid grid-cols-2  md:grid-cols-4 gap-2 items-center"
              key={index}
            >
              ...
              <div className="w-full flex gap-2 flex-col md:gap-3">
                <Link
                  to="/cart"
                  className="w-full bg-black hover:bg-slate-300 hover:text-black duration-300 transition-all md:px-2 py-3 rounded-sm text-white text-center"
                >
                  Add to Cart
                </Link>
                <button className="w-full bg-black hover:bg-slate-300 hover:text-black duration-300 transition-all md:px-2 py-3 rounded-sm text-white">
                  Add to Wishlist
                </button>
              </div>
            </li>
